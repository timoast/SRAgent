...
def create_sragent_agent(
    ...
    state_mod = "\n".join([
        ...
        " 3. Keep track of what you have tried and what information you still need",
        " 4. If one agent returns partial information, use another agent to fill in the gaps",
        " 5. If unsure about any information, cross-validate by calling multiple agents",
        "# Execution rules",
        " 1. Be sure to provide ALL important information each each agent, such as accessions, databases, or metadata fields",
        " 2. Do not simplify metadata fields; ask the agent for the EXACT metadata field",
        ...
        " 5. Provide the agent with concise, clear directions",
        "## Examples",
        "### Incorrect",
        ...
        " 3. Do not use markdown headers or other complex formatting",
